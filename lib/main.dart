...
import 'features\todos\data\todo_repository_impl.dart';
import 'features\todos\presentation\bloc\todo_bloc.dart';
  ...
  runApp(MultiRepositoryProvider(
    ...
    child: MultiBlocProvider(
      providers: [
        ...
        // TodoBloc will be created inside pages when needed
      ],
